...
//<i class="fa fa-sign-in" aria-hidden="true"></i> ICON SING-IN
//<i class="fa fa-sign-out" aria-hidden="true"></i> icon sing-out
//<i class="fa fa-usd" aria-hidden="true"></i> ICON DOLLAR
// <i class="fa fa-bed" aria-hidden="true"></i> icon bed
// <i class="fa fa-map-marker" aria-hidden="true"></i> icon map
//<i class="fa fa-globe" aria-hidden="true"></i> icon world
